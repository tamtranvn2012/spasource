...
$of_options[] = array( 	"name" 		=> "Logo",
						"desc" 		=> "T  H E ME  S H  A RE D   ON    W P  L O C  K E R. CO M - Upload logo here.",
						"id" 		=> "site_logo",
						"std" 		=> "",
						"type" 		=> "media"
);
...
$of_options[] = array( 	"name" 		=> "Top bar left",
				"desc" 		=> "Insert text for for left top bar.",
				"id" 		=> "topbar_left",
...
$of_options[] = array( 	"name" 		=> "HTML after footer W  P L OC K  E R .C OM",
						"desc" 		=> "Enter HTML for footer here. Shortcodes are allowed. F.ex [block id='payments']",
