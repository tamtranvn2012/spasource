...
function flatsome_scripts() {
	...
	/* main style */
	wp_enqueue_style( 'flatsome-style', get_template_directory_uri() .'/style.css?v=1.2' );
	...
	wp_enqueue_script( 'flatsome-theme-js', get_template_directory_uri() .'/js/theme.js?v=1.2', array( 'jquery' ), '20120202', true );
